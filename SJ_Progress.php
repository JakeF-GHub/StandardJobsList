	...
	<table id="SJ_table">
		<thead class='stick1'>
			...
			<tr class='head'>
				...
				<th class ='heading'><div class="caption">Y=YES N=NO</div><div class ='th-dropdown'><div class ='th-dropdown'><button class='th-dropbtn th-hidden' type='button' onclick='viewsDropdown()'>V</button><div class='th-dropdown-content th-dropdownList'><a onclick='newFilters("alphabet","AZ","Del_Sch","Del Schedule A-Z")' >A to Z</a><a onclick='newFilters("alphabet","ZA","Del_Sch","Del Schedule Z-A")'>Z to A</a></div></div>Del Sch</th>
				<th class ='heading'><button class='th-dropbtn th-hidden' type='button' onclick='viewsDropdown()'>V</button><div class='th-dropdown-content th-dropdownList'><a onclick='newFilters("alphabet","AZ","DP_Tappings","Tappings A-Z")'>A to Z</a><a onclick='newFilters("alphabet","ZA","DP_Tappings","Tappings Z-A")'>Z to A</a></div></div><div class="rowHeading">D/P Tappings</div></th>
